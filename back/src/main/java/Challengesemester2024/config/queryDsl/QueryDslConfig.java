package Challengesemester2024.config.queryDsl;
...
// 즉, JPAQueryFactory를 통해 생성한 쿼리는 EntityManager를 통해 데이터베이스와 상호작용하게 됩니다. 이렇게 분리된 역할을 통해 개발자는 쿼리의 생성과 실행을 더욱 효과적으로 관리할 수 있습니다.
