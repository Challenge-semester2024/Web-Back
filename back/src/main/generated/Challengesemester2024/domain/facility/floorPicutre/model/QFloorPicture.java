...
public class QFloorPicture extends EntityPathBase<FloorPicture> {
    ...
    private static final long serialVersionUID = 2021139841L;
    ...
    public QFloorPicture(Class<? extends FloorPicture> type, PathMetadata metadata, PathInits inits) {
        ...
        this.floorPictureCluster = inits.isInitialized("floorPictureCluster") ? new Challengesemester2024.domain.facility.floorPictureCluster.model.QFloorPictureCluster(forProperty("floorPictureCluster"), inits.get("floorPictureCluster")) : null;
    }
