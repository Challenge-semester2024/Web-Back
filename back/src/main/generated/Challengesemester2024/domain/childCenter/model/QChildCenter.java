...
public class QChildCenter extends EntityPathBase<ChildCenter> {
    ...
    private static final long serialVersionUID = 1948019064L;
    ...
    public final Challengesemester2024.domain.greetings.domain.QGreetings greetings;
    ...
    public final Challengesemester2024.domain.routeInfo.domain.QRouteInfo routeInfo;
    ...
    public QChildCenter(Class<? extends ChildCenter> type, PathMetadata metadata, PathInits inits) {
        ...
        this.greetings = inits.isInitialized("greetings") ? new Challengesemester2024.domain.greetings.domain.QGreetings(forProperty("greetings")) : null;
        this.routeInfo = inits.isInitialized("routeInfo") ? new Challengesemester2024.domain.routeInfo.domain.QRouteInfo(forProperty("routeInfo")) : null;
    }
